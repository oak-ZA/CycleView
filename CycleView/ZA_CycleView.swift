...
protocol ZA_CycleViewDelegate {
    func didSelectIndex(index: Int)
}

class ZA_CycleView: UIView,UICollectionViewDelegate,UICollectionViewDataSource,UIScrollViewDelegate{
    ...
    */
    ...
    var delegate: ZA_CycleViewDelegate?
